...
public class Ghost extends Entity {
	 ...
	 */
	public Ghost(Game g, String r, int newX, int newY) {
	...
	public void collidedWith(Entity other) {
		if (other instanceof Player && (game.playerPU == 0 || game.ghostD == 0)) {
			Game.lives--;
			game.notifyGD(1);
			game.ghost1DeathTimer = System.nanoTime();
		} else {
			game.notifyGD(1);
			game.ghost.changeSprite("sprites/GhostR.png");
			game.ghost1DeathTimer = System.nanoTime();
			Game.score += 100;
		}
